describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('A blog can be created', function() {
      ...
      cy.get('.alert')
        .should('contain', 'the blog Canonical string reduction by Edsger W. Dijkstra was added')
  ...
  describe('When a note is created', function() {
    ...
    it('The user that created the blog can delete it', function() {
      cy.get('.view').click()
      cy.get('.remove').click()
      cy.get('html').should('not.contain', 'Canonical string reduction Edsger W. Dijkstra')
    })
  ...
  describe('When several blogs are created', () => {
    ...
    it('The position of a blog changes when it has more likes', () => {
      ...
      cy.get('button').contains('like').click()
      cy.get('button').contains('like').click()
      cy.get('.title').eq(0).should('contain', 'First class tests Robert C. Martin')
    })
  })
})
